...
public class worldCountryEntity {
    ...
    @Basic
    @Column(name = "Name", nullable = false, insertable = true, updatable = true, length = 52)
    ...
    @Basic
    @Column(name = "Continent", nullable = false, insertable = true, updatable = true, length = 13)
    ...
    @Basic
    @Column(name = "Region", nullable = false, insertable = true, updatable = true, length = 26)
    ...
    @Basic
    @Column(name = "SurfaceArea", nullable = false, insertable = true, updatable = true, precision = 2)
    ...
    @Basic
    @Column(name = "LifeExpectancy", nullable = true, insertable = true, updatable = true, precision = 1)
    ...
    @Basic
    @Column(name = "LocalName", nullable = false, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "GovernmentForm", nullable = false, insertable = true, updatable = true, length = 45)
    ...
    @Basic
    @Column(name = "HeadOfState", nullable = true, insertable = true, updatable = true, length = 60)
    ...
    public boolean equals(Object o) {
        ...
        worldCountryEntity that = (worldCountryEntity) o;
